...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    ControllerConstants.operatorController.leftTrigger().whileTrue(Commands.parallel(
        m_conveyor.c_runBottom(Conveyor.Direction.INTAKE, 0.5),
        m_conveyor.c_runTop(Conveyor.Direction.INTAKE, 0.5)));

    ControllerConstants.operatorController.leftBumper().whileTrue(Commands.parallel(
        m_conveyor.c_runBottom(Conveyor.Direction.OUTTAKE, 0.5),
        m_conveyor.c_runTop(Conveyor.Direction.OUTTAKE, 0.5)));
